                ...
                <div style={{padding:"2% 14.455% 2% 14.455%"}} className='container-flex'>
                    <div style={{ fontSize: "20px" }} className='row'>
                        <div className='col-md-6 tablet'>
                            ...
                            <p style={{display:"flex",margin:"-6px", marginBottom:"0px",alignItems:"center"}} className='phone-para'>
                               ...
                               <span> Call us at <b>915295 1313, 915299 1313</b> and state your requirement.</span>
                            </p>

                            <ol className='ordered-list'>
                                <ul style={{marginBottom:"2%", marginTop:"2%"}}>

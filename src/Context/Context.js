...
const ServiceData2 = createContext(["Largest Menu variety with over 1000 dishes from all cuisine types.", "Affordable prices starting from Rs 200/- per person.", "Delicious and freshly prepared food in hygienic kitchens.","Served by the best caterers, who are India's famous chefs.","Specialized catering for all party occasions and celebrations."])
